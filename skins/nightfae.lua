    ...
    overrides = {
        frame = {
            ...
            border = {
                ...
                offset = 10,
                size = 15,
                texture = "nineslice:nightfae",
            },
        },
        accents = {
            center = {
                color = { r = 1, g = 1, b = 1, a = 1 },
                custom_atlas = "CovenantChoice-Celebration-NightfaeSigil",
                desaturated = false,
                height_scale = 1,
                mirror_x = false,
                mirror_y = false,
            ...
            left = {
                ...
                rotation = 0,
                scale = 1,
                selected = "nightfae-sanctum-reservoir",
                width_scale = 1,
            },
            right = {
                color = { r = 1, g = 1, b = 1, a = 1 },
        ...
        health = {
            ...
            texture = {
                atlas = false,
                atlas_texture = false,
                color = { r = 163 / 255, g = 48 / 255, b = 201 / 255, a = 1 },
                desaturated = true,
