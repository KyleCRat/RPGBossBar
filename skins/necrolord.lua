    ...
    overrides = {
        frame = {
            ...
            border = {
                ...
                offset = 10,
                size = 15,
                texture = "nineslice:necrolord",
            },
        },
        accents = {
            center = {
                color = { r = 1, g = 1, b = 1, a = 1 },
                custom_atlas = "CovenantChoice-Celebration-NecrolordSigil",
                desaturated = false,
                height_scale = 1,
                mirror_x = false,
                mirror_y = false,
            ...
            left = {
                ...
                rotation = 0,
                scale = 1,
                selected = "necrolord-sanctum-reservoir",
                width_scale = 1,
            },
            right = {
                color = { r = 1, g = 1, b = 1, a = 1 },
        ...
        health = {
            ...
            texture = {
                atlas = false,
                atlas_texture = false,
                color = { r = 0, g = 248 / 255, b = 152 / 255, a = 1 },
                desaturated = true,
