...
local function Frame(state, context)
    ...
    -- The Venthyr sanctum reservoir is a layered circular accent. All pieces use
...
RPGBB:RegisterAccentGroup({
    id = "venthyr-sanctum-reservoir",
    name = "Venthyr Sanctum Reservoir",
    slots = {
        center = true,
        left = true,
        right = true,
    ...
    textures = {
        {
            ...
            layer = "ARTWORK",
            sublevel = 1,
            atlas = "CovenantSanctum-Resevoir-Empty-Venthyr",
        },
        {
            key = "full",
            layer = "ARTWORK",
            sublevel = 2,
            atlas = "CovenantSanctum-Resevoir-Full-Venthyr",
        },
        {
            key = "glass",
            layer = "ARTWORK",
            sublevel = 3,
            atlas = "CovenantSanctum-Reservoir-Idle-Venthyr-Glass",
        },
        {
            key = "glow",
            layer = "ARTWORK",
            sublevel = 4,
            atlas = "CovenantSanctum-Resevoir-Glow-Venthyr",
        },
        {
            key = "speck",
            layer = "ARTWORK",
            sublevel = 5,
            atlas = "CovenantSanctum-Reservoir-Idle-Venthyr-Speck",
        },
        {
            key = "speck2",
            layer = "ARTWORK",
            sublevel = 6,
            atlas = "CovenantSanctum-Reservoir-Idle-Venthyr-Speck2",
        },
    },
    Render = Frame,
})
