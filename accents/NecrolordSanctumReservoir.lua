...
local function Frame(state, context)
    ...
    -- The Necrolord sanctum reservoir is a layered circular accent. All pieces use
...
RPGBB:RegisterAccentGroup({
    id = "necrolord-sanctum-reservoir",
    name = "Necrolord Sanctum Reservoir",
    slots = {
        center = true,
        left = true,
        right = true,
    ...
    textures = {
        {
            ...
            layer = "ARTWORK",
            sublevel = 1,
            atlas = "CovenantSanctum-Resevoir-Empty-Necrolord",
        },
        {
            key = "full",
            layer = "ARTWORK",
            sublevel = 2,
            atlas = "CovenantSanctum-Resevoir-Full-Necrolord",
        },
        {
            key = "glass",
            layer = "ARTWORK",
            sublevel = 3,
            atlas = "CovenantSanctum-Reservoir-Idle-Necrolord-Glass",
        },
        {
            key = "glow",
            layer = "ARTWORK",
            sublevel = 4,
            atlas = "CovenantSanctum-Resevoir-Glow-Necrolord",
        },
        {
            key = "speck",
            layer = "ARTWORK",
            sublevel = 5,
            atlas = "CovenantSanctum-Reservoir-Idle-Necrolord-Speck",
        },
        {
            key = "speck2",
            layer = "ARTWORK",
            sublevel = 6,
            atlas = "CovenantSanctum-Reservoir-Idle-Necrolord-Speck2",
        },
    },
    Render = Frame,
})
