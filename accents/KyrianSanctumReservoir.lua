...
local function Frame(state, context)
    ...
    -- The Kyrian sanctum reservoir is a layered circular accent. All pieces use
...
RPGBB:RegisterAccentGroup({
    id = "kyrian-sanctum-reservoir",
    name = "Kyrian Sanctum Reservoir",
    slots = {
        center = true,
        left = true,
        right = true,
    ...
    textures = {
        {
            ...
            layer = "ARTWORK",
            sublevel = 1,
            atlas = "CovenantSanctum-Resevoir-Empty-Kyrian",
        },
        {
            key = "full",
            layer = "ARTWORK",
            sublevel = 2,
            atlas = "CovenantSanctum-Resevoir-Full-Kyrian",
        },
        {
            key = "glass",
            layer = "ARTWORK",
            sublevel = 3,
            atlas = "CovenantSanctum-Reservoir-Idle-Kyrian-Glass",
        },
        {
            key = "glow",
            layer = "ARTWORK",
            sublevel = 4,
            atlas = "CovenantSanctum-Resevoir-Glow-Kyrian",
        },
        {
            key = "speck",
            layer = "ARTWORK",
            sublevel = 5,
            atlas = "CovenantSanctum-Reservoir-Idle-Kyrian-Speck",
        },
        {
            key = "speck2",
            layer = "ARTWORK",
            sublevel = 6,
            atlas = "CovenantSanctum-Reservoir-Idle-Kyrian-Speck2",
        },
    },
    Render = Frame,
})
